...
class FloatingText {
  ...
  //don't know how to not let the words covered by the blackhole when appearing on the screen
    this.locx = random(100, windowWidth - 100);
    this.locy = random(50, windowHeight - 100);
